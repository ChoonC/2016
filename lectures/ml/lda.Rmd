...
```{r}
<<<<<<< HEAD
train_set %>% ggplot(aes(X_1,X_2,fill=label)) + geom_point(cex=5, pch=21) +   scale_fill_manual(name="", values=c("#00BFC4","blue","#F8766D"))
=======
...
<<<<<<< HEAD
  ...
  scale_fill_manual(name="", values=c("#00BFC4","blue","#F8766D"))
=======
  geom_point(aes(X_1,X_2,fill=label), dat=test_set,pch=21)
>>>>>>> course/master
```
...
tmp %>% ggplot() +
  stat_contour(aes(x=X_1,y=X_2,z=pred),
               breaks=c(1,2,3),color="black",lwd=1.5) +
<<<<<<< HEAD
  geom_point(aes(X_1,X_2,fill=label), dat=test_set,pch=21) + scale_fill_manual(name="", values=c("#00BFC4","blue","#F8766D"))
```
