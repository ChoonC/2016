...
```{r}
setwd("C:/Users/Choon/Harvard Ext Data Science/2016/homework/HW6/ChoonC-2016HW6")
...
predicted_rating = mu + joined$b_i
model1_RSME <- RMSE(predicted_rating, joined$rating)
model1_RSME
```
...
```{r}
d=dist(t(Y))
plot(hclust(d), labels = substring(movie_titles, 1, 15), cex=0.4)
```
