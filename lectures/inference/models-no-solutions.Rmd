...
A total of 27 people used a sample size of about 100 (between 50 and 150)

```{r}
filter( tab, abs(poll_sample_size-100)<51) %>% nrow
```

Very important: do not confuse the poll sample size with the number of observations (27) in our model. *Here each poll is an observation: $N=27$ while the poll sizes are about 100.*
...
## now use lubridate function mdy to convert to date
